...
public interface IJobExecutionService {
    JobExecution save(String jobName, TaxonomicInput inputData, TaxonomicTarget targetData) throws JobExecutionAlreadyRunningException, JobRestartException, JobInstanceAlreadyCompleteException;
